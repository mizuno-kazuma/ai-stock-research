...
export function mapDocumentRow(raw: unknown): DocumentSummaryRow {
  ...
  return {
    ...
    local_copy_error_ja: d.local_copy_error_ja != null ? str(d.local_copy_error_ja) : null,
...
export function mapDashboard(raw: unknown): DashboardData {
  ...
  return {
    ...
    top_recommendations: uniqueByIssuer(recs),
    watchlist: uniqueByIssuer(watchlist),
    jobs,
  };
}
